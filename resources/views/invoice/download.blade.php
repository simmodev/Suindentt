...
<div class="">
    <h1 class="m-3 p-4 border border-secondary d-inline-block">Suindent Sarl</h1>
    <div class="row">
    ...
    <div class="col-12 mt-4">
        ...
        <h3 class="">Facture Numero : #{{ $invoice->id }}</h3>
    </div>
...
<footer class="border-top border-dark">
    <div class="container text-center">
        <p class="text-muted">Merci pour votre comande.</p>
        <p>N5 KISSARIAT HAY OULED CHRIFA AVENUE LA MARCHE VERTE</p>
        <p>SARL AU CAPITAL DE 10 000,00 DH TP : 29526457 RC: 27247<br>IF : 15234003</p>
        <p>ICE : 001840570000037</p>
    </div>
</footer>
